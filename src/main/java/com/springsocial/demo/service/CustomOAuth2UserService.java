...
import com.springsocial.demo.config.security.OAuth2UserInfo;
import com.springsocial.demo.config.security.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        Optional<UserEntity> userRepositoryByEmail = userRepository.findByEmail(oAuth2UserInfo.getEmail());
        UserEntity userEntity;
        if (userRepositoryByEmail.isPresent()) {
            userEntity = userRepositoryByEmail.get();
